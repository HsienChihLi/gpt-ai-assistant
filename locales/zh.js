const zh = {
  __COMMAND_ANALYZE_ANALYZE_LABEL: '修改信件內容',
  __COMMAND_ANALYZE_ANALYZE_TEXT: '喔喔',
  __COMMAND_ANALYZE_ANALYZE_PROMPT: '將使用者傳送的資訊生成一封信',
  __COMMAND_ANALYZE_LITERARILY_LABEL: '文學分析',
  __COMMAND_ANALYZE_LITERARILY_TEXT: '文學',
  ...
  __COMMAND_SYS_WRITE_LABEL:'選擇以下信件種類',//新增加的
  __COMMAND_SYS_WRITE_TEXT:'寫信',//新增加的
  //__COMMAND_SYS_REPLY_LABEL:'回',//新增加的
  __COMMAND_SYS_REPLY_TEXT:'回信',
  __COMMAND_SYS_MORELETTER_LABEL:'更多信件種類',//新增加的
  __COMMAND_SYS_MORELETTER_TEXT:'更多信件種類',
  __COMMAND_SYS_WRITE_INQUIRY_LABEL:'詢問信',//新增加的
  __COMMAND_SYS_WRITE_INQUIRY_TEXT:'詢問信',
  __COMMAND_SYS_WRITE_INQUIRY_PROMPT: '將使用者傳送的資訊生成一封信',//新增加的
  __COMMAND_SYS_WRITE_SALES_LABEL:'銷售信',
  __COMMAND_SYS_WRITE_SALES_TEXT:'銷售信',
  __COMMAND_SYS_WRITE_CONTRACT_LABEL:'合約信',
  __COMMAND_SYS_WRITE_CONTRACT_TEXT:'合約信',
  __COMMAND_SYS_WRITE_CONTRACT_PROMPT: '寫一封合約信',
  __COMMAND_SYS_WRITE_OVERDUE_LABEL:'催款信',
  __COMMAND_SYS_WRITE_OVERDUE_TEXT:'催款信',//催款信
  __COMMAND_SYS_WRITE_ADVERTISE_LABEL:'廣告信',
  __COMMAND_SYS_WRITE_ADVERTISE_TEXT:'廣告信',//廣告信
  __COMMAND_SYS_WRITE_THANK_LABEL:'感謝信',
  __COMMAND_SYS_WRITE_THANK_TEXT:'感謝信',//感謝信
  __COMMAND_SYS_WRITE_ADVICE_LABEL:'建議信',
  __COMMAND_SYS_WRITE_ADVICE_TEXT:'建議信',
  __COMMAND_TRANSLATE_LABEL:'翻譯',
  __COMMAND_TRANSLATE_TEXT:'翻譯',
  __COMMAND_UP_TEXT:'以上',
  __COMMAND_UP_LABEL:'以上內容',
  __COMMAND_DOWN_TEXT:'以下',
  __COMMAND_DOWN_LABEL:'以下內容',

  __COMMAND_REPLY_UP_TEXT:'回覆上面信件',
  __COMMAND_REPLY_UP_LABEL:'以上內容',
  __COMMAND_REPLY_DOWN_TEXT:'回覆下面信件',
  __COMMAND_REPLY_DOWN_LABEL:'以下內容',

  __COMMAND_TRANSLATE_TO_EN_LABEL: '英文',
  __COMMAND_TRANSLATE_TO_EN_TEXT: '翻成英文',
  __COMMAND_TRANSLATE_TO_EN_PROMPT: '將以上內容翻譯成英文。',
  __COMMAND_TRANSLATE_TO_JA_LABEL: '日文',
  __COMMAND_TRANSLATE_TO_JA_TEXT: '翻成日文',
  __COMMAND_TRANSLATE_TO_JA_PROMPT: '將以上內容翻譯成日文。',
  __COMMAND_TRANSLATE_TO_CN_LABEL:'中文',
  __COMMAND_TRANSLATE_TO_CN_TEXT:'翻成中文',
  __COMMAND_TRANSLATE_TO_CN_PROMPT: '將以上內容翻譯成繁體中文。',
  __COMMAND_TRANSLATE_TO_GM_LABEL:'德文',
  __COMMAND_TRANSLATE_TO_GM_TEXT:'翻成德文',
  __COMMAND_TRANSLATE_TO_GM_PROMPT: '將以上內容翻譯成德文。',

  __COMMAND_TRANSLATE_TO_EN_DOWN_LABEL: '英文',
  __COMMAND_TRANSLATE_TO_EN_DOWN_TEXT: '下面內容翻成英文',
  __COMMAND_TRANSLATE_TO_EN_DOWN_PROMPT: '將以下內容翻譯成英文。',
  __COMMAND_TRANSLATE_TO_JA_DOWN_LABEL: '日文',
  __COMMAND_TRANSLATE_TO_JA_DOWN_TEXT: '下面內容翻成日文',
  __COMMAND_TRANSLATE_TO_JA_DOWN_PROMPT: '將以下內容翻譯成日文。',
  __COMMAND_TRANSLATE_TO_CN_DOWN_LABEL:'中文',
  __COMMAND_TRANSLATE_TO_CN_DOWN_TEXT:'下面內容翻成中文',
  __COMMAND_TRANSLATE_TO_CN_DOWN_PROMPT: '將以下內容翻譯成繁體中文。',
  __COMMAND_TRANSLATE_TO_GM_DOWN_LABEL:'德文',
  __COMMAND_TRANSLATE_TO_GM_DOWN_TEXT:'下面內容翻成德文',
  __COMMAND_TRANSLATE_TO_GM_DOWN_PROMPT: '將以下內容翻譯成德文。',
  __COMMAND_EMAIL_LABEL:'信箱',
  __COMMAND_EMAIL_TEXT:'電子郵件選單',
